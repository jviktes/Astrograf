...
long PULSES_ENC_1 = 36000;              
long PULSES_ENC_2 = 36000;             
...
void read_sensors() {
  ...
  if (encoderValue2 >= PULSES_ENC_2 || encoderValue2 <= -PULSES_ENC_2) {
    encoderValue2 = 0;
  }
  
  int _enc_1 = encoderValue1 / 1500;
  long encoder1_temp = encoderValue1 - (_enc_1 * 1500);
  long map1 = _enc_1 * map(1500, 0, PULSES_ENC_1, 0, 324000); //map(value, fromLow, fromHigh, toLow, toHigh)
  Alt_tel_s = map1 + map(encoder1_temp, 0, PULSES_ENC_1, 0, 324000);
